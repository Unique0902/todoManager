...
def upgrade() -> None:
    ...
    sa.Column('frequency_type', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('frequency_days', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('frequency_count', sa.Integer(), nullable=True),
    sa.Column('frequency_custom', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
